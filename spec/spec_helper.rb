...
module SpecConst
  ...
  TITLES = [TITLE_3, "Increase in acetyl CoA synthetase activity after phenobarbital treatment."]

  # note that the first abstract is actually broken up into sections,
  # so besure that the code to get this puts the space in between the
  # sections
  ABSTRACTS = [ABSTRACT_3, ""]
  PUB_DATES = %w[2013 1975]
